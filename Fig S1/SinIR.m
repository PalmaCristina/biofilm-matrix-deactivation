function dx=SinIR(t,x,gr,pulse_on_duration,pulse_off_duration, pulse_height)
...
vt=0.0125;Kt=0.0021;
apd=spo0Ap_dynamics_square(t,pulse_on_duration,pulse_off_duration, pulse_height);
I=x(1);
IR=x(2);
Id=x(3);
L=x(4);
