function [Ap, ts,kgrowths1, tss,tsers,tdivs]=PhosphorelayGrowthModel_CP
...
kgrowths=[0.5001*ones(1,1),0.5002*ones(1,1),0.5003*ones(1,1),fliplr(kgs)];nrep=numel(kgrowths);
