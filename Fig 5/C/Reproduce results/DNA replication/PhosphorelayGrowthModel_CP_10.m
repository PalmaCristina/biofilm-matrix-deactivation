...
DNA_replication_v=[RepDuration_ori:0.01:RepDuration_ori+2];
...
DNA_replication_v=[DNA_replication_v(1,1)*ones(1,1), DNA_replication_v];
...
for i=1:nrep
    ...
    RepDuration=DNA_replication_v(1,i);
