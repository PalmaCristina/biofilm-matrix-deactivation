...
gr=0.2;
[Ap, ts,kgrowths1, tss,tsers,tdivs]=PhosphorelayGrowthModel_CP_10(gr)
...
[x, y] = ode15s(@(t,x)SinIR(t,x,kgrowths1,Ap_f,ts),[0,120],x0); 
...
plot(x, Tap_value, 'b','Linewidth',1.5);hold on;set(gca,'FontSize',15)
ylabel('[TapA] uM');
xlabel('Time (h)');
% 
