function [Ap, ts,kgrowths1, tss,tsers,tdivs]=PhosphorelayGrowthModel_CP_10
...
Non_rep_ori=[Non_rep_ori:0.3:Non_rep_ori+2];
...
kgrowths=[kgs(1,1)*ones(1,5),(kgs)];nrep=numel(kgrowths);
Non_rep_ori=[Non_rep_ori(1,1)*ones(1,5), Non_rep_ori];
Cell_Cyc=[Cell_Cyc(1,1)*ones(1,5), Cell_Cyc];
