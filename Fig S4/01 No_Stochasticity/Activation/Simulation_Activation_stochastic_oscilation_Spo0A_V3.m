function [ts,y1,ap_values,tcyc_values,time_partition] = Simulation_Activation_stochastic_oscilation_Spo0A_V3(nr_cycles,grate,x_ss)
...
for cell_cycle=1:1:nr_cell_cycles
    tcyc=normrnd(log(2)/grate, 0*(log(2)/grate)); % Random cell cycle length generation
