...
% initial_guess = [0.0385,0.0229,0.0865,0.0912]; % Replace with your initial guess
initial_guess = [0.0385 0.0326 0.1059 0.1315];
% Perform the fitting using fminsearch
lb = [0, 0, 0,0]; % Replace with your bounds
ub = [0.2,0.2, 0.2,0.2]; % Replace with your bounds
