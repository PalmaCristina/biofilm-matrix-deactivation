function [Number_cycles,P_ON] = Probabilities_A_vs_cycles_02(total_cells,g,timef,resultsf)
...
Inspect_times_02=[0:1:(50*(log(2)/grate))];
for i=1:1:total_cells
...
binary_matrix= tapA_inspect>500;

binary_matrix_time= tapA_inspect_time>500;
