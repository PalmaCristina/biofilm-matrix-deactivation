...
for y=1:1:size(gr,2)
    ...
    %Activation
    [timef,resultsf,ap_values_sto,tcyc_sto,time_division] = Activation_Probability(total_cells,gr_v,x_ss_2,nr_cycles);
    filename = ['Activation_', num2str(strrep(num2str(gr_v), '.', '_')), '.mat'];
    save(filename);
    ...
    %Constant Activation
    [timef,resultsf,ap_values_sto,tcyc_sto,time_division] = Constant_Activation_Probability_V3(total_cells,gr_v,x_ss_2,nr_cycles);
    filename = ['Constant_Activation', num2str(strrep(num2str(gr_v), '.', '_')), '.mat'];
    save(filename);
    state=2
