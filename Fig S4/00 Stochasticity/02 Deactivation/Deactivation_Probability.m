function [timef,resultsf,ap_values_sto,tcyc_sto,time_division] = Deactivation_Probability(total_cells,gr_v,x_ss_2,nr_cycles)
...
for cells=1:1:total_cells
   ...
   x_ss=x_ss_2(cells,:);
   [ts,y1,ap_values,tcyc_values,time_partition] = Simulation_Deactivation_stochastic_oscilation_Spo0A_V3(nr_cycles,gr_v,x_ss);
