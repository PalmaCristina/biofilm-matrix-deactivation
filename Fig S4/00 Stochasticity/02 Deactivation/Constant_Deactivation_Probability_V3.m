function [timef,resultsf,ap_values_sto,tcyc_sto,time_division] = Constant_Deactivation_Probability_V3(total_cells,gr_v,x_ss_2,nr_cycles)
tic;
...
for cells=1:1:total_cells
   ...
   x_ss=x_ss_2(cells,:);
     [ts,y1,ap_values,tcyc_values,time_partition] = Simulation_Constant_deactivation_probability_V3(nr_cycles,gr_v,x_ss);
