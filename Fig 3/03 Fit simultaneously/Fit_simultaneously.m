...
s2=plot(x1, fun1(best_params, x1), '--','Color',[1.0000    0.4118    0.1608],'LineWidth',3.5); hold on;
% Calculate MSE
...
s3=scatter(x3, y3, 'o','MarkerEdgeColor','b','MarkerFaceColor','b','MarkerFaceAlpha',0.03,'MarkerEdgeAlpha',0.03); hold on;
s4=plot(x3, fun3(best_params, x3), '--','Color','b','LineWidth',3); hold on;
% Calculate MSE
...
plot(x2, 1-fun2(best_params, x2), '--','Color',[0.8510    0.3255    0.0980],'LineWidth',3); hold on;
% Calculate MSE
residuals = y2 - fun2(best_params, x2);      % Differences
mse_x2 = mean(residuals.^2) % Mean of squared differences

scatter(x4, 1-y4, 'o','MarkerEdgeColor','b','MarkerFaceColor','b','MarkerFaceAlpha',0.03,'MarkerEdgeAlpha',0.03); hold on;
plot(x4, 1-fun4(best_params, x4), '--','Color','b','LineWidth',3); hold on;
% Calculate MSE
